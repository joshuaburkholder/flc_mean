...
!function(app){"use strict";app.registerModule("directories")}(ApplicationConfiguration);
!function(app){"use strict";app.registerModule("gatherings")}(ApplicationConfiguration);
...
!function(app){"use strict";app.registerModule("potlucks")}(ApplicationConfiguration);
"use strict";angular.module("articles").run(["Menus",function(Menus){Menus.addMenuItem("topbar",{title:"Announcements",state:"articles",type:"dropdown",roles:["*"]}),Menus.addSubMenuItem("topbar","articles",{title:"See all announcements",state:"articles.list"}),Menus.addSubMenuItem("topbar","articles",{title:"Post an announcement",state:"articles.create",roles:["user"]})}]);
...
!function(){"use strict";function menuConfig(Menus){Menus.addMenuItem("topbar",{title:"Directories",state:"directories",type:"dropdown",roles:["user","admin"]}),Menus.addSubMenuItem("topbar","directories",{title:"List Directories",state:"directories.list"}),Menus.addSubMenuItem("topbar","directories",{title:"Create Directory",state:"directories.create",roles:["admin"]})}angular.module("directories").run(menuConfig),menuConfig.$inject=["Menus"]}();
!function(){"use strict";function routeConfig($stateProvider){$stateProvider.state("directories",{"abstract":!0,url:"/directories",template:"<ui-view/>"}).state("directories.list",{url:"",templateUrl:"modules/directories/client/views/list-directories.client.view.html",controller:"DirectoriesListController",controllerAs:"vm",data:{pageTitle:"Directories List"}}).state("directories.create",{url:"/create",templateUrl:"modules/directories/client/views/form-directory.client.view.html",controller:"DirectoriesController",controllerAs:"vm",resolve:{directoryResolve:newDirectory},data:{roles:["admin"],pageTitle:"Directories Create"}}).state("directories.edit",{url:"/:directoryId/edit",templateUrl:"modules/directories/client/views/form-directory.client.view.html",controller:"DirectoriesController",controllerAs:"vm",resolve:{directoryResolve:getDirectory},data:{roles:["admin"],pageTitle:"Edit Directory {{ directoryResolve.name }}"}}).state("directories.view",{url:"/:directoryId",templateUrl:"modules/directories/client/views/view-directory.client.view.html",controller:"DirectoriesController",controllerAs:"vm",resolve:{directoryResolve:getDirectory},data:{pageTitle:"Directory {{ directoryResolve.name }}"}})}function getDirectory($stateParams,DirectoriesService){return DirectoriesService.get({directoryId:$stateParams.directoryId}).$promise}function newDirectory(DirectoriesService){return new DirectoriesService}angular.module("directories").config(routeConfig),routeConfig.$inject=["$stateProvider"],getDirectory.$inject=["$stateParams","DirectoriesService"],newDirectory.$inject=["DirectoriesService"]}();
!function(){"use strict";function DirectoriesController($scope,$state,$window,Authentication,directory,Users,$filter){function remove(){$window.confirm("Are you sure you want to delete?")&&vm.directory.$remove($state.go("directories.list"))}function save(isValid){function successCallback(res){$state.go("directories.view",{directoryId:res._id})}function errorCallback(res){vm.error=res.data.message}return isValid?void(vm.directory._id?vm.directory.$update(successCallback,errorCallback):vm.directory.$save(successCallback,errorCallback)):($scope.$broadcast("show-errors-check-validity","vm.form.directoryForm"),!1)}var vm=this;vm.userList=Users.query(),vm.authentication=Authentication,vm.directory=directory,vm.error=null,vm.form={},vm.remove=remove,vm.save=save}angular.module("directories").controller("DirectoriesController",DirectoriesController),DirectoriesController.$inject=["$scope","$state","$window","Authentication","directoryResolve","Users","$filter"]}();
!function(){"use strict";function DirectoriesListController(DirectoriesService){var vm=this;vm.directories=DirectoriesService.query()}angular.module("directories").controller("DirectoriesListController",DirectoriesListController),DirectoriesListController.$inject=["DirectoriesService"]}();
!function(){"use strict";function DirectoriesService($resource){return $resource("api/directories/:directoryId",{directoryId:"@_id"},{update:{method:"PUT"}})}angular.module("directories").factory("DirectoriesService",DirectoriesService),DirectoriesService.$inject=["$resource"]}();
!function(){"use strict";function menuConfig(Menus){Menus.addMenuItem("topbar",{title:"Gatherings",state:"gatherings",type:"dropdown",roles:["*"]}),Menus.addSubMenuItem("topbar","gatherings",{title:"List Gatherings",state:"gatherings.list"}),Menus.addSubMenuItem("topbar","gatherings",{title:"Create Gathering",state:"gatherings.create",roles:["user"]})}angular.module("gatherings").run(menuConfig),menuConfig.$inject=["Menus"]}();
!function(){"use strict";function routeConfig($stateProvider){$stateProvider.state("gatherings",{"abstract":!0,url:"/gatherings",template:"<ui-view/>"}).state("gatherings.list",{url:"",templateUrl:"modules/gatherings/client/views/list-gatherings.client.view.html",controller:"GatheringsListController",controllerAs:"vm",data:{pageTitle:"Gatherings List"}}).state("gatherings.create",{url:"/create",templateUrl:"modules/gatherings/client/views/form-gathering.client.view.html",controller:"GatheringsController",controllerAs:"vm",resolve:{gatheringResolve:newGathering},data:{roles:["user","admin"],pageTitle:"Gatherings Create"}}).state("gatherings.edit",{url:"/:gatheringId/edit",templateUrl:"modules/gatherings/client/views/form-gathering.client.view.html",controller:"GatheringsController",controllerAs:"vm",resolve:{gatheringResolve:getGathering},data:{roles:["user","admin"],pageTitle:"Edit Gathering {{ gatheringResolve.name }}"}}).state("gatherings.view",{url:"/:gatheringId",templateUrl:"modules/gatherings/client/views/view-gathering.client.view.html",controller:"GatheringsController",controllerAs:"vm",resolve:{gatheringResolve:getGathering},data:{pageTitle:"Gathering {{ gatheringResolve.name }}"}})}function getGathering($stateParams,GatheringsService){return GatheringsService.get({gatheringId:$stateParams.gatheringId}).$promise}function newGathering(GatheringsService){return new GatheringsService}angular.module("gatherings").config(routeConfig),routeConfig.$inject=["$stateProvider"],getGathering.$inject=["$stateParams","GatheringsService"],newGathering.$inject=["GatheringsService"]}();
!function(){"use strict";function GatheringsController($scope,$state,$window,Authentication,gathering){function remove(){$window.confirm("Are you sure you want to delete?")&&vm.gathering.$remove($state.go("gatherings.list"))}function save(isValid){function successCallback(res){$state.go("gatherings.view",{gatheringId:res._id})}function errorCallback(res){vm.error=res.data.message}return isValid?void(vm.gathering._id?vm.gathering.$update(successCallback,errorCallback):vm.gathering.$save(successCallback,errorCallback)):($scope.$broadcast("show-errors-check-validity","vm.form.gatheringForm"),!1)}var vm=this;vm.authentication=Authentication,vm.gathering=gathering,vm.error=null,vm.form={},vm.remove=remove,vm.save=save,vm.date=new Date(2017,2,16)}angular.module("gatherings").controller("GatheringsController",GatheringsController),GatheringsController.$inject=["$scope","$state","$window","Authentication","gatheringResolve"]}();
!function(){"use strict";function GatheringsListController(GatheringsService){var vm=this;vm.gatherings=GatheringsService.query()}angular.module("gatherings").controller("GatheringsListController",GatheringsListController),GatheringsListController.$inject=["GatheringsService"]}();
!function(){"use strict";function GatheringsService($resource){return $resource("api/gatherings/:gatheringId",{gatheringId:"@_id"},{update:{method:"PUT"}})}angular.module("gatherings").factory("GatheringsService",GatheringsService),GatheringsService.$inject=["$resource"]}();
...
!function(){"use strict";function routeConfig($stateProvider){$stateProvider.state("potlucks",{"abstract":!0,url:"/potlucks",template:"<ui-view/>"}).state("potlucks.list",{url:"",templateUrl:"modules/potlucks/client/views/list-potlucks.client.view.html",controller:"PotlucksListController",controllerAs:"vm",data:{pageTitle:"Potlucks List"}}).state("potlucks.create",{url:"/create",templateUrl:"modules/potlucks/client/views/form-potluck.client.view.html",controller:"PotlucksController",controllerAs:"vm",resolve:{potluckResolve:newPotluck},data:{roles:["user","admin"],pageTitle:"Potlucks Create"}}).state("potlucks.edit",{url:"/:potluckId/edit",templateUrl:"modules/potlucks/client/views/form-potluck.client.view.html",controller:"PotlucksController",controllerAs:"vm",resolve:{potluckResolve:getPotluck},data:{roles:["user","admin"],pageTitle:"Edit Potluck {{ potluckResolve.name }}"}}).state("potlucks.view",{url:"/:potluckId",templateUrl:"modules/potlucks/client/views/view-potluck.client.view.html",controller:"PotlucksController",controllerAs:"vm",resolve:{potluckResolve:getPotluck},data:{pageTitle:"Potluck {{ potluckResolve.name }}"}})}function getPotluck($stateParams,PotlucksService){return PotlucksService.get({potluckId:$stateParams.potluckId}).$promise}function newPotluck(PotlucksService){return new PotlucksService}angular.module("potlucks").config(routeConfig),routeConfig.$inject=["$stateProvider"],getPotluck.$inject=["$stateParams","PotlucksService"],newPotluck.$inject=["PotlucksService"]}();
!function(){"use strict";function PotlucksListController(PotlucksService){var vm=this;vm.potlucks=PotlucksService.query()}angular.module("potlucks").controller("PotlucksListController",PotlucksListController),PotlucksListController.$inject=["PotlucksService"]}();
!function(){"use strict";function PotlucksController($scope,$state,$window,Authentication,potluck){function remove(){$window.confirm("Are you sure you want to delete?")&&vm.potluck.$remove($state.go("potlucks.list"))}function save(isValid){function successCallback(res){$state.go("potlucks.view",{potluckId:res._id})}function errorCallback(res){vm.error=res.data.message}return isValid?void(vm.potluck._id?vm.potluck.$update(successCallback,errorCallback):vm.potluck.$save(successCallback,errorCallback)):($scope.$broadcast("show-errors-check-validity","vm.form.potluckForm"),!1)}var vm=this;vm.authentication=Authentication,vm.potluck=potluck,vm.error=null,vm.form={},vm.remove=remove,vm.save=save}angular.module("potlucks").controller("PotlucksController",PotlucksController),PotlucksController.$inject=["$scope","$state","$window","Authentication","potluckResolve"]}();
!function(){"use strict";function PotlucksService($resource){return $resource("api/potlucks/:potluckId",{potluckId:"@_id"},{update:{method:"PUT"}})}angular.module("potlucks").factory("PotlucksService",PotlucksService),PotlucksService.$inject=["$resource"]}();
